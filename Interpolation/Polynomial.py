# Finding Point Approximation Using Polynomial Interpolation Method


def polynomial_interpolation_method(points_list, x_to_find):
    """
    Finding point based on the sent x value using Polynomial Interpolation Method
    ...
    # Creating equation system from our List of points
    ...
    # Loop to find Y value approximation
