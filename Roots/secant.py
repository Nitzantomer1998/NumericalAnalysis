# Finding Functions Roots Using Secant Method
...
def secant_method(f, previous_x, current_x, max_iteration_allowed):
    ...
    :param f: Our function
    :param previous_x: The left domain value of the function
    :param current_x: The right domain value of the function
    :param max_iteration_allowed: The maximum iteration allowed for finding a root
    ...
    for i in range(max_iteration_allowed):
        ...
        # Updating the previous_x value to be the current_x
